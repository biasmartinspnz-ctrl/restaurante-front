...
export default function AdminPage(){
    ...
    return(
        <main className="min-h-screen bg-gray-100 P-8">
            <div className="mx-auto max-w-xl rounded-lg bg-pink-300 p-8 shadow">
                ...
                <form onSubmit={cadastrarLanche} className="space-y-5">
                    ...
                    <button
                    type="submit"
                    className="w-full rounded bg-purple-500 py-3 font-semibold text-white hover:bg-purple-600">
                        Cadastrar Lanche
                    </button>
                </form>
